    ...
    switch (activeDomain) {
      ...
      case 'harpro':
        return [
          ...
          { id: 'healthy-index-dashboard', label: 'HI: Dashboard', icon: Activity, desc: 'Healthy Index Overview' },
          { id: 'healthy-index-setting', label: 'HI: Data Setting', icon: Cpu, desc: 'Database Setting Relay' },
          { id: 'healthy-index-uji', label: 'HI: Hasil Uji', icon: FileText, desc: 'Input Form Hasil Uji' },
